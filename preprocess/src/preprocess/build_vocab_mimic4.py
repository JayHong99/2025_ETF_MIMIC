...
def main():
    # all_hosp_adm_dict = load_pickle(os.path.join(processed_data_path, "mimic4/hosp_adm_dict_7days.pkl"))
    all_hosp_adm_dict = load_pickle("/home/data/2025_MIMICIV_processed/mimic4/hosp_adm_dict_7days.pkl")
    all_codes = []
    ...
    build_vocab(all_codes, "/home/data/2025_MIMICIV_processed/mimic4/vocab.pkl")
